...
- (ZscalerSDKTunnelStatus * _Nonnull)status SWIFT_WARN_UNUSED_RESULT;
...
- (BOOL)setupWithWebsiteDataStore:(WKWebsiteDataStore * _Nonnull)websiteDataStore SWIFT_WARN_UNUSED_RESULT SWIFT_AVAILABILITY(ios,introduced=17);
